...
class Ui_pointConfigDialog(object):
    def setupUi(self, pointConfigDialog):
        ...
        pointConfigDialog.resize(330, 512)
        ...
        self.label_5 = QtWidgets.QLabel(self.lineStyleWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_6 = QtWidgets.QLabel(self.lineWidthWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, pointConfigDialog):
        ...
        self.label_5.setText(_translate("pointConfigDialog", "Split line style"))
        ...
        self.label_6.setText(_translate("pointConfigDialog", "Split line width"))
