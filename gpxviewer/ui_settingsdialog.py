...
class Ui_settingsDialog(object):
    def setupUi(self, settingsDialog):
        ...
        self.boldFontLabel = QtWidgets.QLabel(self.groupBox_2)
        self.boldFontLabel.setObjectName("boldFontLabel")
        self.gridLayout.addWidget(self.boldFontLabel, 1, 0, 1, 1)
        self.boldFontCheckBox = QtWidgets.QCheckBox(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.italicFontCheckBox.setLayoutDirection(QtCore.Qt.RightToLeft)
        ...
        self.distanceCoeffSpinBox.setMaximumSize(QtCore.QSize(100, 16777215))
        ...
        self.timezoneSpinBox.setMaximumSize(QtCore.QSize(100, 16777215))
        ...
        self.pointsToTrackLabel = QtWidgets.QLabel(self.tab)
        self.pointsToTrackLabel.setObjectName("pointsToTrackLabel")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.pointsToTrackLabel)
        self.pointsToTrackCheckBox = QtWidgets.QCheckBox(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pointsToTrackCheckBox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.pointsToTrackCheckBox.setObjectName("pointsToTrackCheckBox")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.pointsToTrackCheckBox)
        self.deletePointsLabel = QtWidgets.QLabel(self.tab)
        self.deletePointsLabel.setObjectName("deletePointsLabel")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.deletePointsLabel)
        self.deletePointsCheckBox = QtWidgets.QCheckBox(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.deletePointsCheckBox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.deletePointsCheckBox.setObjectName("deletePointsCheckBox")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.deletePointsCheckBox)
        self.tracksToPointsLabel = QtWidgets.QLabel(self.tab)
        self.tracksToPointsLabel.setObjectName("tracksToPointsLabel")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.tracksToPointsLabel)
        self.tracksToPointsCheckBox = QtWidgets.QCheckBox(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tracksToPointsCheckBox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.tracksToPointsCheckBox.setObjectName("tracksToPointsCheckBox")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.tracksToPointsCheckBox)
        self.deleteTracksLabel = QtWidgets.QLabel(self.tab)
        self.deleteTracksLabel.setObjectName("deleteTracksLabel")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.deleteTracksLabel)
        self.deleteTracksCheckBox = QtWidgets.QCheckBox(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.deleteTracksCheckBox.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.deleteTracksCheckBox.setObjectName("deleteTracksCheckBox")
        self.formLayout_4.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.deleteTracksCheckBox)
        self.verticalLayout_5.addLayout(self.formLayout_4)
        spacerItem10 = QtWidgets.QSpacerItem(20, 210, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
